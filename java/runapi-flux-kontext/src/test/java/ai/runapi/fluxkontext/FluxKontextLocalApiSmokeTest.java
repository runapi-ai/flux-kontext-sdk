...
import ai.runapi.fluxkontext.types.TextToImageResponse;
    ...
    class FluxKontextLocalApiSmokeTest {
      ...
      void startServer() throws IOException {
        ...
        server.createContext("/api/v1/flux_kontext/text_to_image", this::handleRequest);
        server.start();
      }
      ...
      void runUsesApacheTransportAgainstLocalApi() throws Exception {
        try (FluxKontextClient client =
            FluxKontextClient.builder()
                .apiKey("sk-test")
      ...
      CompletedTextToImageResponse response =
        ...
        assertEquals("/api/v1/flux_kontext/text_to_image", create.path);
      ...
      private void handleRequest(HttpExchange exchange) throws IOException {
        ...
        assertEquals("/api/v1/flux_kontext/text_to_image/task_local_123", captured.path);
