package ai.runapi.fluxkontext.resources;
...
public final class TextToImageResource extends FluxkontextResource {
  /** API endpoint path for text to image operations. */
  public static final String ENDPOINT = "/api/v1/flux_kontext/text_to_image";
